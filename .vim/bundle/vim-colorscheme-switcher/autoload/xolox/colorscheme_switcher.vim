...
function! xolox#colorscheme_switcher#delete()
	let curent_scheme = g:colors_name
	let file_name = "/home/ptendulk/.vim/colors/".curent_scheme.".vim"
	call xolox#colorscheme_switcher#cycle(1)
	call delete(file_name)
	call xolox#misc#msg#info('Deleted file : %s', file_name)
endfunction
