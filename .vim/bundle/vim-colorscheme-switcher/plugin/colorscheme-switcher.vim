...
if xolox#misc#option#get('colorscheme_switcher_define_mappings', 1)
  ...
  inoremap <silent> <C-F9> <C-O>:RandomColorScheme<CR>
  nnoremap <silent> <C-F9> :RandomColorScheme<CR>
endif
...
command! -bar DeleteColorScheme call xolox#colorscheme_switcher#delete()
